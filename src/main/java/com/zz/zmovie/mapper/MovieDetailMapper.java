...
public interface MovieDetailMapper extends BaseMapper<MovieDetail> {
    ...
    List<TopMovies> getNewest36(int start);
    ...
    List<SearchMovie> selectNameLike(String name);
    ...
    List<SearchMovie> selectByName(String name);
    ...
    List<SearchMovie> selectSummaryLike(String summary);
